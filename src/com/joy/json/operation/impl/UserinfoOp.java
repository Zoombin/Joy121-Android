...
import com.joy.json.parse.UserinfoParse;

public class UserinfoOp implements ITaskOperation {
	...
	public Object exec(Object in, Object res) throws Exception {
		...
		HttpGet get = httpApi.createHttpGet(
				IP,
				new BasicNameValuePair("action", "user_info"),
				...
				new BasicNameValuePair("token", new MD5()
						.getMD5ofStr(SharedPreferencesUtils
								.getLoginName(JoyApplication.getSelf())
								+ MD5.key)));
		return (UserEntity) httpApi.doHttpRequest(get, new UserinfoParse());
	}
}
