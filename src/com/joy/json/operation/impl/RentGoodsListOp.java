...
import com.joy.json.parse.RentGoodsListParse;

public class RentGoodsListOp implements ITaskOperation {
	@Override
	public Object exec(Object in, Object res) throws Exception {
		...
		HttpGet get = httpApi.createHttpGet(
				IP,
				new BasicNameValuePair("action", "getofficedepotlist"),
		...
		RentGoodsListEntity rentGoodsListEntity = (RentGoodsListEntity) httpApi.doHttpRequest(get, new RentGoodsListParse());
		return (rentGoodsListEntity) ;
	}
}