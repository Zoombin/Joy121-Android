...
public class ActjoinOp implements ITaskOperation {
	...
	public Object exec(Object in, Object res) throws Exception {
		...
		HttpGet get = null;
		if(entity.isActionCancel()){
			get = httpApi.createHttpGet(
					IP,
					new BasicNameValuePair("action", "comp_act_quit"),
					new BasicNameValuePair("json", String.format(
							"{\"loginname\":\"%s\",\"actid\":\"%s\"}", SharedPreferencesUtils
									.getLoginName(JoyApplication.getSelf()), entity.getActId())),
