...
import com.joy.Widget.PerformanceAdapter;
...
public class PerformanceActivity extends BaseActivity implements OnClickListener {
	...
	private ListView list_performance;
	...
	protected View ceateView(LayoutInflater inflater, Bundle savedInstanceState) {
		...
		View v = inflater.inflate(R.layout.activity_performance, null);
		resources = getResources();
		setContentView(v);
		initView();
		initData();
	...
	private void initView() {
		...
		tv_title.setText(R.string.row_performance);//绩效考核
		...
		list_performance = (ListView) findViewById(R.id.list_performance);
		uiAdapter.setMargin(list_performance, LayoutParams.MATCH_PARENT,
				LayoutParams.WRAP_CONTENT, 0, 0, 0, 0);
		adapter = new PerformanceAdapter(self, self);
		list_performance.setAdapter(adapter);
	}
	
	private void initData() {
		String reportType = "2";//类型：绩效
