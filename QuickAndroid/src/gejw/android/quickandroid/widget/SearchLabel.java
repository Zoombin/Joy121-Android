...
public class SearchLabel extends FrameLayout implements OnGlobalLayoutListener{
    ...
    public SearchLabel(Context context, AttributeSet attrs, int defStyle) {  
        super(context, attrs, defStyle);  
        init();  
    }  
  
    public SearchLabel(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        init();  
    }  
