		...
		public CustomDialog create() {
			...
			if (confirm_btnText != null) {
				...
				layout.findViewById(R.id.confirm_btn).setVisibility(
						View.GONE);
				layout.findViewById(R.id.cancel_btn).setBackgroundResource(R.drawable.btn_select);
			}
			...
			if (cancel_btnText != null) {
				...
				layout.findViewById(R.id.cancel_btn).setVisibility(
						View.GONE);
				layout.findViewById(R.id.confirm_btn).setBackgroundResource(R.drawable.btn_select);
			}
